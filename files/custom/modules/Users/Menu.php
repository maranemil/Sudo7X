...
if($GLOBALS['current_user']->isAdminForModule('Users'))
{
    ...
    if(isset($_REQUEST['record'])){
        ...
        $module_menu[] = Array("index.php?module=Users&action=SudoLogin&record=".$_REQUEST['record'], $mod_strings['LBL_LOGIN_AS'].$log_user->user_name,"SudoLogin");
    }
}

if(!empty($_SESSION['sudo_user'])) {
    $module_menu[] = Array("index.php?module=Users&action=SudoLogout", $mod_strings['LBL_LOGOUT_AS'].$current_user->user_name,"SudoLogin");
}
